...
class FunctionsLib extends CI_Model {
	...
	*/
	 ...
	 * Ã  partir d'aujourd'hui au format aaaamm, y compris le mois courant
	 * A noter: compte-tenu du fonctionnement de la méthode DateTime::sub,
	 * il peut arriver que l'on retrouve 2 fois le mÃªme mois parmi
	...
	*/
	...
	/**
	 * Vérifie si une date est inférieure d'un an Ã  la date actuelle
	...
	*/
	...
	/**
	 * Vérifie la validité du format d'une date franÃ§aise jj/mm/aaaa 
